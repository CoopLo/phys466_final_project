...
if __name__ == '__main__':
    ...
    for num_atoms in n_atoms:
        ...
        np.save("./dynamic_run_dat/en_trace_{}_{}".format(int(num_atoms),
                                               energy_model), en)
        np.save("./dynamic_run_dat/occ_trace_{}_{}".format(int(num_atoms),
                                               energy_model), occ_num)
        np.save("./dynamic_run_dat/acc_rate_{}_{}".format(int(num_atoms),
